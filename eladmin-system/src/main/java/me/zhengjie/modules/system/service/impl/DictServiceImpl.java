...
public class DictServiceImpl implements DictService {
    ...
    public void create(Dict resources) {
        ...
        if (dictRepository.findByName(resources.getName()) != null) {
            throw new EntityExistException(Dict.class, "name", resources.getName());
        }
    ...
    public void update(Dict resources) {
        ...
        if (dict1 != null && !dict1.getId().equals(resources.getId())) {
            throw new EntityExistException(Dict.class, "username", resources.getName());
        }
        // 清理缓存
        delCaches(resources);
