...
@NoArgsConstructor
public class ApprovalProcess extends BaseEntity implements Serializable {
    ...
    public void copy(ApprovalProcess process) {
        BeanUtil.copyProperties(process, this, CopyOptions.create().setIgnoreNullValue(true));
    }
}