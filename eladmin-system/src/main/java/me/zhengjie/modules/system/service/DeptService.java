...
public interface DeptService {
     ...
     * @throws Exception /
     */
    List<DeptFileDto> queryAllV2(DeptQueryCriteria criteria, Boolean isQuery) throws Exception;
    ...
    /**
     * 导出数据V2--包含文件数目和部门权限范围
     *
     * @param list     待导出的数据
     * @param response /
     * @throws IOException /
     */
    void downloadV2(List<DeptFileDto> list, HttpServletResponse response) throws IOException;
     ...
     * @return 符合条件的部门数据
     */
    List<DeptFileDto> queryDeptByExample(DeptQueryCriteriaV2 criteria);
     ...
     * @return 所在公司所有部门数据
     */
    List<DeptDto> getDeptTree(DeptDto deptDto);

    /**
     * @param deptId 部门标识
     * @return 上级部门标识集合
     */
    Set<Long> getSuperiorIds(Long deptId);
}