...
import me.zhengjie.service.dto.LogDelCond;
...
//    @PreAuthorize("@el.check()")
    ...
    @PostMapping(value = "/del/info/byCond")
    @Log("根据条件删除INFO日志")
    @ApiOperation("根据条件删除INFO日志")
    @PreAuthorize("@el.check()")
    public ResponseEntity<Object> delInfoByCond(@RequestBody LogDelCond cond) {
        logService.delInfoByCond(cond);
        return new ResponseEntity<>(HttpStatus.OK);
    }
