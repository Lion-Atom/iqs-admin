...
@Api(tags = "工具：仪校机构V2")
@RequestMapping("/api/caliOrgV2")
public class CaliOrgV2Controller {

    private final CaliOrgV2Service caliOrgService;
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody CalibrationOrgV2Dto resource) {
