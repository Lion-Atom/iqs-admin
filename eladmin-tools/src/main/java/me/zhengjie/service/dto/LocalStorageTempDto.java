...
@Getter
@Setter
public class LocalStorageTempDto extends BaseDTO implements Serializable {
    ...
    private Set<BindingDeptTemp> bindTempDepts;

    private List<String> bindDeptStr = new ArrayList<>();

    private Set<BindingLocalStorageTemp> bindTempFiles;
