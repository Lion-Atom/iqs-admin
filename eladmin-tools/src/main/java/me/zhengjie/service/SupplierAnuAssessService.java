 ...
 */
public interface SupplierAnuAssessService {
     ...
     * @return 新客户审核信息
     */
    SupplierAnnualAssessment create(SupplierAnnualAssessment resources);
     ...
     * @param resources /
     */
    void update(SupplierAnnualAssessment resources);
